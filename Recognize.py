...
def recognize_attendence():
    ...
    minThreshold = 67 # Accurate minThresold = 67
    # recognize = True;
    while True:
        ret, im = cam.read()
...
def writeToFile(attendance):
    ...
    print("xlsx file submission started here.")
    fileNameXLSX = "Attendance" + os.sep + "Attendance_" + date + ".xlsx";
    pd.read_csv(fileName).to_excel(fileNameXLSX)


    print("Attendence successful in xlsx format. Bingo!")
